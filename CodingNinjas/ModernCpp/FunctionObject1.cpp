...
private:
    void(*fp)();
public:
    Func(void(*ff)()):fp(ff) //ctr is initialized automatically here with the functon pointer 
    { }
    void Set(void(*ff)())
    {
        fp = ff;
    ...
    void operator()()  // FUNCTOR // trying to overload the function operator  
    {
        (*fp)();
    }
};
...
int main()
{
    Func obj1(&fun1); // object 1 is called function object 
    // obj1.Invoke();  => try out the functor
    obj1(); // obj1.operator()
    cout <<"*******************" << endl;
    obj1.Set(&fun2);
    //obj1.Invoke();
